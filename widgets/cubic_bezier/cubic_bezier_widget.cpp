...
// https://docs.lvgl.io/master/examples.html#cubic-bezier-animation
...
static void page_obj_init(lv_obj_t *par) {
    ...
    lv_obj_add_event_cb(ginfo.p1_slider, slider_event_cb,
                        LV_EVENT_VALUE_CHANGED, NULL);
    lv_obj_add_event_cb(ginfo.p2_slider, slider_event_cb,
                        LV_EVENT_VALUE_CHANGED, NULL);
    ...
    lv_obj_add_event_cb(ginfo.run_btn, run_button_event_handler,
    ...
    ginfo.ser1 = lv_chart_add_series(
        ginfo.chart, lv_palette_main(LV_PALETTE_RED), LV_CHART_AXIS_PRIMARY_Y);
...
void cubic_bezier_widget_init(lv_display_t *disp) {
    lv_obj_t *scr = lv_display_get_screen_active(disp);

    static int32_t col_dsc[] = {LV_GRID_FR(1), 200, LV_GRID_FR(1),
                                LV_GRID_TEMPLATE_LAST};
    static int32_t row_dsc[] = {30, 10, 10, LV_GRID_FR(1),
                                LV_GRID_TEMPLATE_LAST};

    lv_obj_set_style_pad_all(scr, 2, LV_PART_MAIN);
    lv_obj_set_style_pad_column(scr, 10, LV_PART_MAIN);
    ...
    int32_t end = lv_obj_get_style_width(scr, LV_PART_MAIN) -
